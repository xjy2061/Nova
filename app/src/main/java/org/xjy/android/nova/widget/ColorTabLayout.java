...
public class ColorTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link ColorTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link ColorTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Add a {@link ColorTabLayout.OnTabSelectedListener} that will be invoked when tab selection
     * changes.
     *
    ...
    /**
     * Remove the given {@link ColorTabLayout.OnTabSelectedListener} that was previously added via
    ...
    /**
     * Remove all previously added {@link ColorTabLayout.OnTabSelectedListener}s.
     */
    ...
    /**
     * Returns the current mode used by this {@link ColorTabLayout}.
     *
     * @see #setTabMode(int)
     */
    @Mode
    ...
    public void setTabTextSize(@Dimension int textSize) {
    ...
    public void setTabTextMaxLines(int maxLines) {
        if (mTabTextMaxLines != maxLines) {
            mTabTextMaxLines = maxLines;
            updateAllTabs();
        }
    }

    public void setTabBackgroundDrawable(Drawable drawable) {
        mTabBackgroundDrawable = drawable;
    }
    ...
    /**
     * The one-stop shop for setting up this {@link ColorTabLayout} with a {@link ViewPager}.
     *
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context) {
            ...
            if (mTabBackgroundDrawable != null) {
                ViewCompat.setBackground(this, mTabBackgroundDrawable);
            }
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (mTextView != null) {
                ...
                int maxLines = mTabTextMaxLines > 0 ? mTabTextMaxLines : mDefaultMaxLines;
     ...
     * necessary calls back to the provided {@link ColorTabLayout} so that the tab position is
     * kept in sync.
     *
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public TabLayoutOnPageChangeListener(ColorTabLayout tabLayout) {
        ...
        public void onPageScrolled(final int position, final float positionOffset,
            ...
            final ColorTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
    ...
    /**
     * A {@link ColorTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements ColorTabLayout.OnTabSelectedListener {
